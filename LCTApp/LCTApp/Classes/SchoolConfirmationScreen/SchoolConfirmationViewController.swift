//
//  SchoolConfirmationViewController.swift
//  LCTApp
//
...
class SchoolConfirmationViewController: UIViewController {
   ...
   // @IBOutlet weak var lblSorority: UILabel!
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        let sororityAttriString = NSMutableAttributedString(string: "N.P.O", attributes: dict)
